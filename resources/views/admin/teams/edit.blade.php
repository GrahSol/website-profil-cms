            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.teams.update', $team->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        @if($team->avatar)
                            <img src="{{ Storage::url($team->avatar) }}" alt="" class="rounded-2xl object-cover w-[90px] h-[90px] mb-3">
                        @endif
                    ...
                    <div class="flex items-center justify-end mt-4 gap-3">
                        <a href="{{ route('admin.teams.index') }}" class="font-bold py-4 px-6 bg-gray-500 text-white rounded-full">
                            Cancel
                        </a>
