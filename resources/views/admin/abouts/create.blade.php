                ...
                <form method="POST" action="{{ route('admin.abouts.store') }}" enctype="multipart/form-data"> 
                    ...
                    <div class="mt-4">
                        ...
                        <select name="type" id="type" class="py-3 rounded-lg pl-3 w-full border border-slate-300">
                            ...
                            <option value="Visions" {{ old('type') == 'Visions' ? 'selected' : '' }}>Visions</option>
                            <option value="Missions" {{ old('type') == 'Missions' ? 'selected' : '' }}>Missions</option>
                        </select>
                    ...
                    <div class="mt-4">
                        <div class="flex flex-col gap-y-5">
                            @for($i=0; $i < 3; $i++)
                                ...
                                placeholder="Write your keypoint" name="keypoints[]" value="{{ old('keypoints.'.$i) }}">
                            @endfor
                        </div>
