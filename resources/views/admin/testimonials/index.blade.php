            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-row justify-between items-center">
                    <div class="flex flex-row items-center gap-x-3">
                        ...
                        <div class="flex flex-col">
                            <h3 class="text-indigo-950 text-xl font-bold">
                                {{ $testimonial->client ? $testimonial->client->name : 'No Client' }}
                            </h3>
                    ...
                    <div class="hidden md:flex flex-row items-center gap-x-3">
                        <a href="{{ route('admin.testimonials.edit', $testimonial) }}" class="font-bold py-3 px-5 bg-indigo-700 text-white rounded-full">
                            Edit
                        </a>
                ...
                @empty
                <p class="text-slate-500 text-center py-5">No testimonials found</p>
                @endforelse
